...
if __name__ == '__main__':
    print(repeated_word(""))
    print(repeated_word("quick brown fox jumps over lazy dog."))
    print(repeated_word("Hello world hello"))
    print(repeated_word("The cat and the hat are on the mat."))
    print(repeated_word("I saw a fox, and the fox saw me!"))
    print(repeated_word("1 2 3 1 2 3 4"))
    print(repeated_word("@#$% hello @#$% world @#$% hello"))
